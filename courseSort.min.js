var Exports={Modules:{}};
Exports.Modules=function(b,g){var e="year=2015",h=window.location.href.split("?")[0];init=function(){openPanels();initFilters()};openPanels=function(){if(0<b(".course-filter").find(".coursebuttonselected").length){var c=b(".coursebuttonselected").parents("div.panel-default");b(c).find("[data-toggle]").attr("data-toggle","no-collapse").removeClass("collapsed");b(c).find(".panel-collapse").removeClass("in")}};initFilters=function(){b(".coursebuttonblack").click(function(c){event.preventDefault();b(".coursebuttonselected").toggleClass("coursebutton coursebuttonselected");
...
g&&b(".showing-courses").text(function(b,d){return d.replace(/\d+/,c)})};return{init:init}}(jQuery);$(document).ready(function(){Exports.Modules.init()});function hello(b){alert("Hello, "+b)}hello("New user");
